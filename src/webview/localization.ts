export const ENGLISH_WEBVIEW_MESSAGES = {
  ...
  providerModelsHint: 'Model ids your endpoint exposes, comma-separated. Add :contextSize to set a model\'s context window (e.g. model-id:32k) — most local endpoints do not report this, so known models keep the built-in capacity table value and unknown models default to 256K. Test the connection to fill ids in automatically.',
